...
export default function Plantofthemonth() {
    ...
    return (
        <div className="bg-customNewBg flex flex-col min-h-screen">
            <h1 className="text-[9rem] md:text-[9rem] font-chicle text-center text-customHover mb-8 z-10 relative">
                Plant of the Month
            </h1>
            ...
            <div className="flex w-full relative flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2">
                    <div className="flex items-start justify-center md:justify-end mt-4 md:mt-[-9rem]">
                        <img
                    ...
                    <div className="text-customPLNTS pr-5 md:pr-20 py-4 md:py-16">
                        <h1 className="text-5xl md:text-7xl font-victor-serif mb-4 text-center md:text-left">Anthurium Clarinervium</h1>
                        <p className="mb-6 pr-5 md:pr-40 text-center md:text-left">
                        ...
                        <div className="flex flex-col items-center md:flex-row space-y-2 md:space-y-0 md:space-x-4">
                            <button className="flex items-center text-customPLNTS text-center">
