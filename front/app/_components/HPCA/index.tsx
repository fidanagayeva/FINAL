    ...
    return (
        <div className="container mx-auto px-8 py-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                <div className="relative overflow-hidden flex flex-col justify-center items-center h-[24rem]">
                    <img
                        ...
                        className="w-[17rem] h-full object-cover"
                        alt="Houseplants"
                    />
                    ...
                    <Link href="/houseplants">
                        <button
                            className="absolute w-[15rem] bottom-6 left-1/2 transform -translate-x-1/2 px-6 py-2 bg-white/30 text-white border border-white rounded-3xl 
