  ...
  return (
    <div className="relative w-full">
      <Carousel
        ...
        showThumbs={false}
        showStatus={false}
        className="bg-customHover text-white"
      >
        <div className="flex flex-col items-center justify-center h-[28rem] p-6">
          ...
          <div className="text-center mt-4 mx-[10rem]">
      ...
      <button
        className="absolute left-20 top-1/2 transform -translate-y-1/4 p-2 bg-customHover rounded-full text-white hover:text-customHover border border-white hover:bg-white"
        onClick={handlePrev} 
      >
        <LiaChevronLeftSolid />
      </button>
      ...
      <button
        className="absolute right-20 top-1/2 transform -translate-y-1/4 p-2 bg-customHover rounded-full text-white hover:text-customHover border border-white hover:bg-white"
        onClick={handleNext} 
      >
