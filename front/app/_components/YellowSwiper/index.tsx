...
export default function YellowCarousel() {
  ...
  return (
    <div className="relative w-full">
      ...
      >
        <div className="flex flex-col items-center justify-center h-[28rem] p-4 sm:h-[24rem] md:h-[26rem]">
          <h3 className="text-[0.9rem]">4.5 out of 5 stars, based on 20,800+ reviews</h3>
          <div className="flex mt-2">
            {[...Array(5)].map((_, index) => (
              <IoStarSharp key={index} className="text-white mt-2 text-xl" />
            ))}
          </div>
          <div className="text-center mt-4 mx-4 sm:mx-6">
            <h2 className="text-3xl sm:text-4xl font-victor-serif font-bold">
        ...
        <div className="flex flex-col items-center justify-center h-[28rem] p-4 sm:h-[24rem] md:h-[26rem]">
          ...
          <div className="text-center mt-4 mx-4 sm:mx-6">
            <h2 className="text-3xl sm:text-4xl font-victor-serif font-bold">
              It’s so nice when you get a hand-written thank you on the note:) Make me feel special!
            </h2>
          </div>
