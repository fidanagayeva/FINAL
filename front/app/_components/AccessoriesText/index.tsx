    ...
    <div className="p-4 sm:p-6 md:p-10 ml-2 sm:ml-5 bg-customBG min-h-screen mb-[-9rem] lg:mb-[-20rem]">
      ...
      <div className="mt-4 text-center sm:text-left">
        ...
        <p className="mt-4 text-sm sm:text-base text-customText leading-snug max-w-prose">
          Meet the newest member of your accessories family. Accessories come in all shapes, sizes, and styles and we have a huge variety in our shop. So take a good look around and choose the indoor plants that will be the perfect additions to your home!
        </p>
