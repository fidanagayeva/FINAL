...
export default function CareText() {
  return (
    <div className="p-4 sm:p-6 md:p-10 ml-2 sm:ml-5 bg-customBG min-h-screen 
      ...
      <div className="flex items-center text-xs sm:text-sm space-x-1 sm:space-x-2 text-customText">
        ...
        <span>/</span>
        <span className="text-customText underline">Care</span>
      </div>
      ...
      <div className="mt-4">
        ...
        Meet the newest member of your Care family. Care come in all shapes, sizes and styles and we have a huge variety in our shop. So take a good look around and choose the indoor plants that will be the perfect additions to your home!Read less
        </p>
