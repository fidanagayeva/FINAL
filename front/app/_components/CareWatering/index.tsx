    ...
    return (
        <div>
            <div className="flex p-14 flex-col lg:flex-row">
                ...
                <div className="w-full lg:w-3/5 p-4 mx-0 lg:mx-12 flex flex-col justify-start items-center lg:items-start">
                    <h1 className="text-3xl lg:text-5xl font-bold font-victor-serif text-customText leading-tight text-center lg:text-left">
                        We are happy to help you care for your plants!
                    </h1>

                    <div className="mt-6 p-4 w-full border border-custombgclr bg-custombgclr">
                        <div className="flex flex-col space-y-4 lg:space-y-0 lg:flex-row lg:space-x-6 items-center text-center lg:text-left">
                    ...
                    <h2 className="text-xl font-bold mt-8 mb-4 text-customText text-center lg:text-left">Watering</h2>
                    <p className="mt-2 text-customText text-base text-center lg:text-left mb-6">
            ...
            <div className='bg-customCareBg min-h-[23rem] md:mt-[-11rem] flex flex-col justify-end p-4'>
                <Link href="/care">
                    <h2 className="text-sm font-bold text-center md:text-end text-white mb-4 cursor-pointer mr-11">All care products</h2>
                </Link>
                <div className="flex flex-col md:flex-row justify-center md:justify-end space-y-4 md:space-y-0 md:space-x-4 mr-0 md:mr-10">
                    {cards.slice(0, 3).map((card) => (
                        <div key={card.id} className="relative overflow-hidden transition-transform cursor-pointer flex flex-col items-center">
                            <img
                                src={card.image}
                                alt={card.title}
                            ...
                            <p className="text-sm text-white italic text-center">{card.description}</p>
